...
Trong UI backend có nút sinh MP3 bằng fal.ai. Chức năng này chỉ đọc `description`, lưu file vào `public/audio/NN.mp3`, tự cập nhật `audioUrl` thành `/audio/NN.mp3`, và mỗi bài chỉ được sinh tối đa 10 lần.
